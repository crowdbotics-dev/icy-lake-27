"""
Django settings for icy_lake_27 project.
...
WSGI_APPLICATION = 'icy_lake_27.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "icy_lake_27 API",
    "DESCRIPTION": "API documentation for icy_lake_27 App",
    "VERSION": "v1",
}
